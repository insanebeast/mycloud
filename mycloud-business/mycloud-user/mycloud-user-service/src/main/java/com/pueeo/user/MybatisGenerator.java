        ...
        FastAutoGenerator.create(url, username, password)
                .globalConfig(builder -> {
                    builder.author("pueeo") // 设置作者
                            ...
                            .outputDir(System.getProperty("user.dir") + "/mycloud-business/mycloud-user/mycloud-user-service/src/main/java"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.pueeo.user") // 设置父包名
...
//                            .controller("controller")
                            ...
                            .mapper("mapper")
                            .xml("mapper")
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml,System.getProperty("user.dir") + "/mycloud-business/mycloud-user/mycloud-user-service/src/main/resources/mapper/")); // 设置mapperXml生成路径
                })
