...
import com.pueeo.im.utils.ByteBufHelper;
...
import static com.pueeo.im.utils.ByteBufHelper.byteBufferWithLengthHead;
...
public class JsonMsgDemo {
    ...
    public void serAndDesr() throws IOException {
        ...
        System.out.println("devId:=" + inMsg.getId());
    ...
    public void testJsonEncoder() {
        ...
        while (null!=outmsg &&  outmsg.readableBytes() > 0) {
            System.out.println(ByteBufHelper.byteBuf2String(outmsg));
